...
router.post("/admin", proteger, admin, pedidosController.crearPedidoAdmin);
router.post("/admin/detalles", proteger, admin, pedidosController.crearDetallePedidoAdmin);
router.post("/admin/compras", proteger, admin, pedidosController.crearCompraAdmin);
...
router.put("/admin/detalles/:id", proteger, admin, pedidosController.actualizarDetallePedidoAdmin);
...
router.delete("/admin/detalles/:id", proteger, admin, pedidosController.eliminarDetallePedidoAdmin);
